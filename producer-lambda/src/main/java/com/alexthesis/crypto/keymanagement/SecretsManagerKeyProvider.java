...
/**
 * AWS Secrets Manager implementation of the KeyProvider interface for Lambda modules.
 *
 * <p>Retrieves and deserializes cryptographic key secrets from AWS Secrets Manager.
 * This is the concrete Quarkus bean used by both Producer and Consumer lambdas.
 */
@ApplicationScoped
