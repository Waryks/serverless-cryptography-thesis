package com.alexthesis.validation.crypto;
 ...
 *
 * <p>Uses the same canonical serialization and verification logic as the consumer-lambda's
 * {@code VerificationService}, ensuring consistency across the pipeline.
 *
...
public class SignatureVerifier {
    ...
    public SignatureVerifier(ObjectMapper objectMapper) {
